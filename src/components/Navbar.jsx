  ...
  return (
    <nav className="fixed w-full z-50 bg-gray-900/90 backdrop-blur-sm py-4 px-8 shadow-lg">
        <div className='container mx-auto flex justify-between items-center'>
            <div>
                <a href='#' className='text-3xl font-bold text-white'>Poonam<span className='text-purple-500'>Gautam</span>
                <div className='w-4 h-4 bg-purple-500 rounded-full'></div></a>
            </div>
...
<div className='hidden md:flex space-x-10'>
      ...
      <div className='md:hidden'>
  {
    showMenu 
     ...
     {
        showMenu && (
            <div className='md:hidden mt-4 bg-gray-900/90 h-screen rounded-lg p-4 flex flex-col space-y-4 text-center justify-center'>
<a onClick={()=>setShowMenu(!showMenu)} href='#home' className='relative inline-block text-white/80 transition duration-300 hover:text-purple-500 group'>
  <span>Home</span>
